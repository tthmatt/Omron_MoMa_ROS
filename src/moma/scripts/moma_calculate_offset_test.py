...
if __name__ == "__main__":
    ...
    landmark_to_obj.transform.translation.x = 418.25
    landmark_to_obj.transform.translation.y = 316.37
    landmark_to_obj.transform.translation.z = 718.32
    ...
    print "offset(object_location w.r.t. landmark_location:"
